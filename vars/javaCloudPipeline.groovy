                ...
                steps {
                    withCredentials([azureServicePrincipal('sp-ipim-ip-aks')]) {
                        script {
                            ...
                            sh "docker tag ${ACRLOGINSERVER}/${DOCKER_ORG_IMAGE}:${DOCKER_VERSION} docker-registry-default.ocp-02.ikeadt.com/${OPENSHIFT_PPE}/${DOCKER_OPENSHIFT_IMAGE}:${DOCKER_VERSION}"
                            sh "docker push docker-registry-default.ocp-02.ikeadt.com/${OPENSHIFT_PPE}/${DOCKER_OPENSHIFT_IMAGE}:${DOCKER_VERSION}"
...
//                            docker push ${AWS_CONTAINER_REPOSITORY_URL_PROP}/${DOCKER_ORG_IMAGE}:${DOCKER_VERSION}
            ...
            stage ('DEV Deploy - OnPrem OpenShift') {
                ...
                steps {
                    script {
                        sh "~/oc/openshift-origin-client-tools-v3.11.0-0cbc58b-linux-64bit/./oc project ${OPENSHIFT_PPE}"
