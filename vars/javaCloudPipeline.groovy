        ...
        stages {
            ...
            stage('Test API Blueprint') {
                steps {
                    script {
                        try {
                            sh 'dredd init -r apiary -j apiaryApiKey:ce16ad7641d98a84d231ebb0b1a14292 -j apiaryApiName:ipimipproductapi --endpoint http://dev-az-svc.westeurope.cloudapp.azure.com '
