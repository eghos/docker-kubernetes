                ...
                steps {
                    withCredentials([azureServicePrincipal('sp-ipim-ip-aks')]) {
                        script {
                            ...
                            sh "docker tag ${ACRLOGINSERVER}/${DOCKER_ORG_IMAGE}:${DOCKER_VERSION} docker-registry-default.ocp-02.ikeadt.com/sandbox-ipim-ip/${DOCKER_ORG_IMAGE}:${DOCKER_VERSION}"
                            sh "docker push docker-registry-default.ocp-02.ikeadt.com/sandbox-ipim-ip/${DOCKER_ORG_IMAGE}:${DOCKER_VERSION}"
