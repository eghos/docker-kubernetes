    ...
    pipeline {
        ...
        stages {
            ...
            stage('API Fortress Tests') {
                steps {
                    sh 'python apif-run.py run-by-id https://ikea.apifortress.com/app/api/rest/v3/a340aba1-b0c1-45cd-8d2b-26ccd74c4b023 -i 5bab61ec30c49e00012c0f49 -e "apif_env:dev-environment" -o test-result.json'
                }
            }
